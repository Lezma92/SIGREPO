    ...
    <div id="wrapper">
      ...
      <div class="container-fluid " style="margin-bottom: 85px;">
        ...
        <div class="card-body misael" style="padding: 8px;">
          ...
          <?php
          $res = vistas::resultadoTotal($categoria, "Integradora");
          ...
          $verResultados = vistas::getTdosProyectos($categoria, "Integradora", $mostrarPag, $articulosxpagina,$carrera);
              ...
              <div class="card-group col-md-4">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text">
                      <strong>
                        <?php echo ($value["nombreAlumno"]); ?>
                      </strong><br>
                      <strong>
                        <?php echo ("Grupo: " . $value["grupo"]); ?>
                      </strong><br>
                    ...
                    <p class="card-text"><small class="text-muted">
                        ...
                        <form method="POST">
                          ...
                          <?php if ($_SESSION["nivel"] == "Administrador") { ?>
                            <button type="button" name="eliminar" onclick="eliminarRepositorios(<?php echo ($value["idProyecto"]); ?>,<?php echo ($value["matricula"]); ?>,'<?php echo ($value["nombre_proyecto"]); ?>',1,'<?php echo ($_GET["cat"]); ?>',<?php echo ($_GET["pag"]); ?>);" id="eliminar" class="btn  bg-danger">
                              Eliminar
                            </button>
                          <?php } ?>
                        </form>
