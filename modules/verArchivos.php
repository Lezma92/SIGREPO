...
?>
	...
	<body id="page-top">
		...
		<div id="wrapper">
			...
			?>
			<div class="container-fluid _detalle_repo">
				...
				<div class="row mb-5">
					<div class="col-12 col-md-11 col-lg-10 mx-auto">
						...
						<table class="table isSearch table-responsive" id="table_id">
							<thead>
							...
							<tbody>
								...
								?>
									<tr>
										...
										<td class="body-item d-md-flex display-7">
										<button type="button" class="btn btn-nvo bg-primary mb-2 mb-md-0 mr-md-2" data-toggle="modal" data-target="#modalComentario"><i class="far fa-comments"></i></button>
											<a href="<?php echo ($value["ruta"]); ?>" class="btn btn-nvo btn-warning button_descargar mb-2 mb-md-0 mr-md-2" download>Descargar</a>
